...
dropList.forEach((dropDown, i) => {
    for (let currency_code in country_code) {
        let selected = i == 0 ? (currency_code == "BDT" ? "selected" : "") : (currency_code == "USD" ? "selected" : "");
...
function getExchangeRate() {
    ...
    let url = `https://v6.exchangerate-api.com/v6/8151cbdb8dbb852ba30a919d/latest/${fromCurrency.value}`;
